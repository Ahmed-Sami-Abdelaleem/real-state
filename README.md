...
- 9- A guest account can also have a rating and the total number of ratings for the guest
...
- 12- Every booking lists the tax paid, the total price for the stay, the total price with taxes
